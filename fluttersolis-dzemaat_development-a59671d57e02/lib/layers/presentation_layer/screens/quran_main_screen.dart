...
import 'package:dzemaat/layers/data_layer/data_providers/get_quran_data.dart';
import 'package:dzemaat/layers/presentation_layer/screens/quran_sub_list_screen.dart';
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (ctx, index) {
                    return _buildSingleMainContainer(
                      ...
                      subTitle: snapshot.data[index].surahNameTranslation,
